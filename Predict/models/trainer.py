...
class trainer():
    ...
    def test(model, save_path_resume, device, dataloader, scaler, model_name, save=True, **kwargs):
        ...
        for i in range(12):
            ...
            pred    = yhat[:,:,i]
            real    = realy[:,:,i]
            if kwargs['dataset_name'] == 'PEMS04' or kwargs['dataset_name'] == 'PEMS08' or kwargs["dataset_name"] == "NYTV":  # traffic flow dataset follows mae metric used in ASTGNN.
