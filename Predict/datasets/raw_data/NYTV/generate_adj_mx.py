...
direction = True
distance_df_filename, num_of_vertices, id_filename = "datasets/raw_data/NYTV/NYTV_wkt.csv", 3598, None
if direction:
...
pickle.dump(adj_mx, open("datasets/sensor_graph/adj_mx_NY.pkl", 'wb'))
pickle.dump(distance_mx, open("datasets/sensor_graph/adj_mx_NY_distance.pkl", 'wb'))
