...
def generate_train_val_test(args):
    ...
    pickle.dump(_max, open("datasets/NYTV/max.pkl", 'wb'))
    pickle.dump(_min, open("datasets/NYTV/min.pkl", 'wb'))
...
if __name__ == "__main__":
    ...
    dataset        = "NYTV"    # PEMS or METR
    output_dir  = 'datasets/NYTV'
    traffic_df_filename = 'datasets/raw_data/NYTV/NYTV.npz'
